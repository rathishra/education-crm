                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="course_type_id" id="courseTypeSelect">
                                ...
                                <option value="<?= $ct['id'] ?>"
                                    ...
                                    <?= old('course_type_id') == $ct['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="duration_years" id="durationYears"
                                       value="<?= e(old('duration_years', '')) ?>" min="1" max="10"
                                       placeholder="Auto from Course Type">
...
(function () {
    ...
    function applyFromType() {
        ...
        if (dur > 0) {
            ...
            if (!durInput.dataset.userSet) durInput.value = '';
        }
    }

    ctSelect.addEventListener('change', applyFromType);

    // On page load apply if a type is already selected (e.g. after validation failure)
    if (ctSelect.value) applyFromType();
})();
</script>
