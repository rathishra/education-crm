...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <nav aria-label="breadcrumb"><ol class="breadcrumb mb-0 small">
            ...
            <li class="breadcrumb-item active"><?= e($subject['subject_code']) ?></li>
        </ol></nav>
    </div>
    ...
    <div class="row g-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="subject_code" class="form-control text-uppercase <?= isset($errors['subject_code'])?'is-invalid':'' ?>"
                                   value="<?= e(old('subject_code',$subject['subject_code'])) ?>">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="short_name" class="form-control" value="<?= e(old('short_name',$subject['short_name']??'')) ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Subject Type</label>
                            <select name="subject_type" class="form-select">
                                <?php $selType = old('subject_type',$subject['subject_type']); ?>
                                <?php foreach(['theory','lab','tutorial','project','elective'] as $t): ?>
                                <option value="<?= $t ?>" <?= $selType===$t?'selected':'' ?>><?= ucfirst($t) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="semester" class="form-select">
                                ...
                                <?php $selSem = old('semester',$subject['semester']); ?>
                                <?php for($i=1;$i<=10;$i++): ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="course_id" class="form-select select2">
                                ...
                                <option value="<?= $c['id'] ?>" <?= old('course_id',$subject['course_id'])==$c['id']?'selected':'' ?>><?= e($c['name']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Regulation</label>
                            <input type="text" name="regulation" class="form-control" value="<?= e(old('regulation',$subject['regulation']??'')) ?>">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="description" class="form-control" value="<?= e(old('description',$subject['description']??'')) ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <?php foreach([['credits','Credits',0.5],['hours_per_week','Hours/Week',1],['theory_hours','Theory Hours',1],['lab_hours','Lab Hours',1],['tutorial_hours','Tutorial Hours',1]] as [$n,$l,$st]): ?>
                    <div class="mb-3">
                        <label class="form-label fw-semibold"><?= $l ?></label>
                        <input type="number" name="<?= $n ?>" class="form-control" value="<?= e(old($n,$subject[$n]??0)) ?>" min="0" step="<?= $st ?>">
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
            <button type="submit" class="btn btn-primary w-100"><i class="fas fa-save me-2"></i>Update Subject</button>
